...
A robust Java console application designed to calculate a student's Cumulative Grade Point Average (CGPA). It takes course credits and various assessment marks (Class Test, Attendance, Final Exam) as input to determine the final Grade Point and letter grade.

## 🚀 Features

* **Detailed Input:** Accepts individual scores for Class Tests (CT), Attendance (AT), and Final Exams (FE).
* **Automatic Grading:** Converts numerical marks into Grade Points (4.00 scale) automatically.
* **Credit Tracking:** Distinguishes between "Credits Taken" and "Credits Earned" (excludes failed courses).
* **Final Output:** Displays a summary including Student ID, Total Credits, CGPA, and Final Letter Grade.

## 📜 The Source Code

Save the following code in a file named `CGPACalculator.java`:
